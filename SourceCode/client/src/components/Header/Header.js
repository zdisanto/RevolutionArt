...
const Header = ({ onButtonClick }) => {
  ...
  const logout = () => {
    dispatch({type: actionType.UPDATE_SUBS_INFO, payload: subscriptionInitialState})
    ...
    <div>
      ...
      <div className="flex flex-row max-h-28 min-h-28 px-6 px-y-12 justify-between bg-gray-100">
        ...
        <div className="flex md:block pt-10 items-center">
          <form onSubmit={handleSearch}>
            ...
            <button
              ...
              className="md:right-5 right-6 top-5 border-gray-400 py-2 text-2xl text-gray-500 hover:text-black"
            >
              <CiSearch />
            </button>
          </form>
        ...
        {activate ? (
              ...
              <div className="group">
                ...
                <ul className="absolute py-1 invisible group-hover:visible transition duration-75 ease-in-out">
                  <li className="absolute divide-y divide-gray-200 text-xl overflow-auto h-auto right-0 top-0 bg-white p-3 w-72">
                    <div>
                      <p className="font-bold text-sm text-center pb-2">
                        Messages
                      </p>
                    </div>
                    {/* divider */}
                    <div className="px-3 py-3 text-xs hover:bg-gray-100">
                      ...
                      <p>
                        The "Art in Focus" will be host on Nov4 at Whitney in
                        NYC!{" "}
                        <em className="underline text-blue-700">
                          Click to know more!
                        </em>
                      </p>
                    </div>
                    ...
                    <div className="px-3 py-3 text-xs hover:bg-gray-100">
                      ...
                      <p>
                        Dear Customer, Your Order NY122102 is just confirmed by
                        its seller!{" "}
                        <em className="underline text-blue-700">View More!</em>
                      </p>
                    </div>
                    {/* divider */}
                    <div className="px-3 py-3 text-xs hover:bg-gray-100">
                      <p className="font-bold mb-1">
                        Someone Comments Your Works!
                      </p>
                      <p>
                        Hey! Someone looks very interested in your works, reply
                        to chat!{" "}
                        <em className="underline text-blue-700">
                          More details!
                        </em>
              ...
              <div className="group">
                ...
                <ul className="absolute py-1 invisible group-hover:visible transition duration-75 ease-in-out">
                  <li className="absolute divide-y divide-gray-200 text-xl overflow-auto h-auto right-0 top-0 bg-white p-3 w-72">
                      ...
                      <div className="pl-5 pt-2">
                        {img == undefined ? (
                          <p className="font-bold text-sm">
                            {user.result.email.slice(
                              0,
                              user.result.email.indexOf("@")
                            )}
                          </p>
                        ) : (
                          <p className="font-bold text-sm">
                    ...
                    <Link
                      to="/accountsettings"
                      className="flex pl-6 py-2 hover:bg-gray-100"
                    >
                    ...
                    {/* divider */}
                    <button
                      className="flex pl-24 pr-32 py-2 text-white text-center text-sm text-bold bg-gray-800 hover:bg-black"
                      onClick={logout}
                    >
                      Logout
                    </button>
          ...
          <button
            className="bg-gray-300 hover:bg-gray-800 hover:text-white py-2 px-2 my-8 rounded"
      ...
      <nav className="flex bg-gray-800 text-white px-28 h-full">
        <ul className="flex gap-12 items-stretch h-full py-2">
          ...
          <li className="group">
            ...
            <ul className="sub1">
              <li>
                <a className="sub2">{">"} Best Selling Categories</a>
              </li>
              <li>
                <a className="sub2">{">"} Art Movement</a>
              </li>
              <li>
                <a className="sub2">{">"} Best Sellers By Price</a>
              </li>
            </ul>
          </li>
          <li className="group">
